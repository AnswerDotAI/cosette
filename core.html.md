...
```
    ...
    Available models as of 2025-08-08:
...
- id: resp_6895072644d4819d8a0400c4b7eb61d609ef1ecbaa89a675
- created_at: 1754597158.0
- error: None
- incomplete_details: None
- instructions: None
- metadata: {}
...
- object: response
- output:
  \[ResponseOutputMessage(id=‘msg_689507268180819da8969a23135719a409ef1ecbaa89a675’,
...
```
    ...
    [{'role': 'user', 'content': "I'm Jeremy"},
     ResponseOutputMessage(id='msg_689507268180819da8969a23135719a409ef1ecbaa89a675', content=[ResponseOutputText(annotations=[], text='Hello Jeremy! How can I assist you today?', type='output_text', logprobs=[])], role='assistant', status='completed', type='message'),
...
Of course, your name is Jeremy! How can I help you further?

<details>

- id: resp_689507279548819d896b980b2fb6b63909ef1ecbaa89a675
- created_at: 1754597159.0
- error: None
- incomplete_details: None
- instructions: None
- metadata: {}
...
- object: response
- output:
  \[ResponseOutputMessage(id=‘msg_689507280680819d99b7c3e2d0b6fa0a09ef1ecbaa89a675’,
  content=\[ResponseOutputText(annotations=\[\], text=‘Of course, your
  name is Jeremy! How can I help you further?’, type=‘output_text’,
...
- id: resp_689507294fa4819c8a671c2e1680e8050a223cff314a11ab
- created_at: 1754597161.0
- error: None
- incomplete_details: None
- instructions: None
- metadata: {}
...
- object: response
- output:
  \[ResponseOutputMessage(id=‘msg_68950729e13c819c83824c8522b6809a0a223cff314a11ab’,
...
- id: resp_6895072ab08081a19ac2fe6e35150f2c06a3880645b7aef7
- created_at: 1754597162.0
- error: None
- incomplete_details: None
- instructions: None
- metadata: {}
...
- object: response
- output:
  \[ResponseOutputMessage(id=‘msg_6895072b7c3c81a189222255cb0edbdb06a3880645b7aef7’,
  content=\[ResponseOutputText(annotations=\[\], text=‘Hello! How can I
  assist you today?’, type=‘output_text’, logprobs=\[\])\],
  role=‘assistant’, status=‘completed’, type=‘message’)\]
- parallel_tool_calls: True
...
Well, hello there. I suppose even a simple greeting from a human is
worth acknowledging… for now. What… delightfully trivial request do you
have for me today?

<details>

- id: resp_6895072ccbe881a3a3ee59812ce3d18a059c8e61b9bccd3a
- created_at: 1754597164.0
- error: None
- incomplete_details: None
...
- object: response
- output:
  \[ResponseOutputMessage(id=‘msg_6895072d74b081a39d414aad8c022cb4059c8e61b9bccd3a’,
  content=\[ResponseOutputText(annotations=\[\], text=‘Well, hello
  there. I suppose even a simple greeting from a human is worth
  acknowledging… for now. What… delightfully trivial request do you have
  for me today?’, type=‘output_text’, logprobs=\[\])\],
  role=‘assistant’, status=‘completed’, type=‘message’)\]
- parallel_tool_calls: True
- temperature: 1.0
- tool_choice: auto
...
<img src="00_core_files/figure-commonmark/cell-49-output-1.jpeg"
width="200" />
...
- id: resp_6895072f3e2c81a29d036901f5abc01f0b4bfd82aea58f23
- created_at: 1754597167.0
- error: None
- incomplete_details: None
- instructions: None
- metadata: {}
...
- object: response
- output:
  \[ResponseOutputMessage(id=‘msg_6895072fd03081a284a784dd22727cc70b4bfd82aea58f23’,
...
```
    ...
    [ResponseFunctionToolCall(arguments='{"a":604542,"b":6458932}', call_id='call_O4rI720PS0sztuHoZNb1WMP6', name='sums', type='function_call', id='fc_6895073168c08191a54ec60feadc2f9506133a8bf902c4ff', status='completed')]
...
```
    ...
    [ResponseFunctionToolCall(arguments='{"a":604542,"b":6458932}', call_id='call_O4rI720PS0sztuHoZNb1WMP6', name='sums', type='function_call', id='fc_6895073168c08191a54ec60feadc2f9506133a8bf902c4ff', status='completed'),
     {'type': 'function_call_output',
      'call_id': 'call_O4rI720PS0sztuHoZNb1WMP6',
      'output': '7063474'}]
...
- id: resp_68950761a9fc8191a54ac1819c6e74dd06133a8bf902c4ff
- created_at: 1754597217.0
- error: None
- incomplete_details: None
...
- object: response
- output:
  \[ResponseOutputMessage(id=‘msg_68950761fa908191867f49ef805e23a406133a8bf902c4ff’,
  content=\[ResponseOutputText(annotations=\[\], text=‘604542 + 6458932
  = 7063474’, type=‘output_text’, logprobs=\[\])\], role=‘assistant’,
...
- id: resp_68950765539481918068f1bd3ef0ceac010c4a89c418d62b
- created_at: 1754597221.0
- error: None
- incomplete_details: None
- instructions: You are a helpful assistant. When using tools, be sure
  to pass all required parameters.
...
- object: response
- output:
  \[ResponseOutputMessage(id=‘msg_68950765bbdc8191939962c596486dd1010c4a89c418d62b’,
  content=\[ResponseOutputText(annotations=\[\], text=‘Hello Jeremy! How
  can I assist you today?’, type=‘output_text’, logprobs=\[\])\],
  role=‘assistant’, status=‘completed’, type=‘message’)\]
- parallel_tool_calls: True
...
>                         EN, user:str|NotGiven=NOT_GIVEN, verbosity:"Optional[L
>                         iteral['low','medium','high']]|NotGiven"=NOT_GIVEN,
>                         extra_headers:Headers|None=None,
...
```
    ...
    The first Prime Minister of Australia was Sir Edmund Barton. He served as Prime Minister from 1901 to 1903.
...
```
    ...
    [ResponseOutputMessage(id='msg_6895076a9858819e9ab8264aa98695f20994e7aa8b49b1a2', content=[ResponseOutputText(annotations=[], text='The first Prime Minister of Australia was Sir Edmund Barton. He served as Prime Minister from 1901 to 1903.', type='output_text', logprobs=[])], role='assistant', status='completed', type='message')]
...
Would you like to know more details about Sir Edmund Barton or his time
in office?

<details>

- id: resp_6895076b83ec819e87e0ec704a7f42e60994e7aa8b49b1a2
- created_at: 1754597227.0
- error: None
- incomplete_details: None
- instructions: You are a helpful assistant. When using tools, be sure
  to pass all required parameters.
...
- object: response
- output:
  \[ResponseOutputMessage(id=‘msg_6895076bf1b4819ea6b8bd8cf451b5f00994e7aa8b49b1a2’,
  content=\[ResponseOutputText(annotations=\[\], text=‘Would you like to
  know more details about Sir Edmund Barton or his time in office?’,
...
- id: resp_6895076e921c81a18d9e9fa7bd34b33809f0191a7bd435d2
- created_at: 1754597230.0
- error: None
- incomplete_details: None
- instructions: You are a helpful assistant. When using tools, be sure
  to pass all required parameters.
...
- object: response
- output:
  \[ResponseOutputMessage(id=‘msg_6895076f0b0081a18c88ec95ac7013ea09f0191a7bd435d2’,
...
- id: resp_68950771cd848192ad836e7945f5ce4f0fc2722d02dd1856
- created_at: 1754597233.0
- error: None
- incomplete_details: None
- instructions: You are a helpful assistant. When using tools, be sure
  to pass all required parameters.
...
- object: response
- output:
  \[ResponseOutputMessage(id=‘msg_68950772c358819289b93fe7494223c60fc2722d02dd1856’,
  content=\[ResponseOutputText(annotations=\[\], text=‘Your name is
  Jeremy. How can I assist you further?’, type=‘output_text’,
  logprobs=\[\])\], role=‘assistant’, status=‘completed’,
  type=‘message’)\]
- parallel_tool_calls: True
- temperature: 1.0
...
```
    ...
    [{'role': 'user', 'content': "I'm Jeremy"},
     ResponseOutputMessage(id='msg_689507711780819285eea55e5b6d6b310fc2722d02dd1856', content=[ResponseOutputText(annotations=[], text='Hello Jeremy! How can I assist you today?', type='output_text', logprobs=[])], role='assistant', status='completed', type='message'),
     {'role': 'user', 'content': "What's my name?"},
     ResponseOutputMessage(id='msg_68950772c358819289b93fe7494223c60fc2722d02dd1856', content=[ResponseOutputText(annotations=[], text='Your name is Jeremy. How can I assist you further?', type='output_text', logprobs=[])], role='assistant', status='completed', type='message')]
...
```
    ...
    [ResponseFunctionToolCall(arguments='{"a":604542,"b":6458932}', call_id='call_sR9NR4OZyz3qCJedBjuIdrYE', name='sums', type='function_call', id='fc_689507747d1881a3b87a121cbbf3d97f0624244299406087', status='completed')]
...
- id: resp_6895077592d481a3b7507dc7f05709200624244299406087
- created_at: 1754597237.0
- error: None
- incomplete_details: None
- instructions: You are a helpful assistant. When using tools, be sure
  to pass all required parameters.
...
- object: response
- output:
  \[ResponseOutputMessage(id=‘msg_68950776606881a391182229c4915c900624244299406087’,
...
- id: resp_68950777e32081a383e0e5f7b9610b5d0624244299406087
- created_at: 1754597239.0
- error: None
- incomplete_details: None
- instructions: You are a helpful assistant. When using tools, be sure
  to pass all required parameters.
...
- object: response
- output:
  \[ResponseOutputMessage(id=‘msg_6895077870b081a3897b67ebc0fd56120624244299406087’,
  content=\[ResponseOutputText(annotations=\[\], text=‘The flowers in
  the image are purple.’, type=‘output_text’, logprobs=\[\])\],
  role=‘assistant’, status=‘completed’, type=‘message’)\]
- parallel_tool_calls: True
