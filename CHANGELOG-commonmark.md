...
- Validate tool names returned by model against allowed tools
  ([\#34](https://github.com/AnswerDotAI/cosette/pull/34)), thanks to
...
- Add 5.1 and 5.2 models
  ([\#33](https://github.com/AnswerDotAI/cosette/issues/33))
...
- Add gpt-oss models
  ([\#31](https://github.com/AnswerDotAI/cosette/issues/31))

### Bugs Squashed

- Use json.loads for func args instead of ast.literal_eval
  ([\#32](https://github.com/AnswerDotAI/cosette/pull/32)), thanks to
